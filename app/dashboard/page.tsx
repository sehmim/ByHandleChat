    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-600">Active Widget</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Update hours, policies, and more</p>
            </a>
          </div>
        </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">You're all set up!</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-green-100 flex items-center justify-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Services Added</p>
                <p className="text-xs text-gray-600">4 services configured</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-green-100 flex items-center justify-center">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Widget Deployed</p>
                <p className="text-xs text-gray-600">Your chat widget is live</p>
              </div>
            </div>
          </div>
        </div>
